...
Tauri v2 desktop app: an AsciiDoc editor with live preview, built on CodeMirror 6 (editor) and Asciidoctor.js (renderer). Frontend is TypeScript/Vite, native shell is Rust. Currently at milestones 1–4 of the plan in [README.md](README.md); milestone 5 (file open/save, scroll sync, HTML/PDF export) is not yet implemented.
